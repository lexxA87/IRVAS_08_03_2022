...
var modals = function modals() {
  ...
  showModalWindow(".popup_engineer_btn", ".popup_engineer", ".popup_engineer .popup_close");
  ...
  showModalWindow(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", false); // showModalWindowByTime(".popup", 60000);
};
